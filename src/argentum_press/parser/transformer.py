...
class CardTransformer(Transformer):
    ...
    def legendrulestatement(self, items):
        from argentum_press.parser.ast import Expression, LegendRuleStatement
