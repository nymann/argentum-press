...
class CardTransformer(Transformer):
    ...
    def legendrulestatement(self, items):
        from argentum_press.parser.ast import ChooseNewTargetsForCopyExpression, DoOnlyOnceEachTurnStatement, Expression, LegendRuleStatement
    ...
    def choosenewtargetsforcopyexpression(self, items):
        from argentum_press.parser.ast import ChooseNewTargetsForCopyExpression, DoOnlyOnceEachTurnStatement, Expression
